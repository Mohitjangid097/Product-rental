...
if (isset($work)) {
        ...
        values ('$product_id', '$itemname', '$profileImageName', '$itemcategory', '$caption', '$cost', '$refund', '$day_charge', '0', '0', '0', '$date', '$exp_date', 'Y')") or die("failed to query database".mysqli_error());
    ...
    echo '<script type ="text/javascript"> alert("Item Uploaded Successfully");window.location= "seller.php"</script>';
